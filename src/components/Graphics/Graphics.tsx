        ...
        <div className="graphics__humanbox">
          ...
          <div className="graphics__human">
            ...
            <input
              ...
              id="keypoint-2"
              name="keypoints"
              onClick={() => handleClick("shoulder-l")}
            />
            <input
              type="radio"
              ...
              id="keypoint-3"
              name="keypoints"
              onClick={() => handleClick("shoulder-r")}
            />
            <input
              type="radio"
